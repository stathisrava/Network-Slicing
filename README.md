...
The repository is intended to accompany the corresponding diploma thesis and provides the implementation used for the experiments presented in the thesis.
